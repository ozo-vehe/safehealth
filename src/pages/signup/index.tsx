      ...
      <div className="flex flex-wrap items-center justify-center">
        <LogInContainer justifyContent="center" alignItems="center">
          ...
          <InnerLogInContainer>
            ...
            <div className="flex my-5 flex-col gap-2 items-center border border-slate-300 overflow-hidden rounded-[8px]">
              <input
                name="email"
                value={form.email}
                type="email"
            ...
            <NoAccount>
              Already have an account yet?<Bold onClick={() => router.push('/login')}>LOGIN</Bold>
            </NoAccount>
          </InnerLogInContainer>
        </LogInContainer>
      </div>
